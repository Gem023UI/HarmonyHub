...
<head>
  ...
  <!-- CSS DIRECTORY -->
  <link rel="stylesheet" href="../../design/header/categoryheader.css"/>
      ...
      <div class="d-flex align-items-center me-auto">
        ...
        <div class="dropdown ms-3">
          ...
          <ul class="dropdown-menu" aria-labelledby="categoryDropdown">
            <li><a class="dropdown-item" href="acoustic.php">Acoustic</a></li>
            <li><a class="dropdown-item" href="lespaul.php">Les Paul</a></li>
            <li><a class="dropdown-item" href="stratocaster.php">Stratocaster</a></li>
            <li><a class="dropdown-item" href="telecaster.php">Telecaster</a></li>
